                    ...
                    <div class="text-box">
                        ...
                        <div class="text">
                            <p class="text-justify">Martaloka konveksi hadir untuk membantu Anda dalam memiliki kaos
                                ...
                                seperti kaos event, kaos promosi perusahaan, kaos klub hobi, kaos fans, dan kaos partai
                                dengan kualitas yang terjaga. Dengan melakukan seluruh proses produksi secara mandiri,
            ...
            <div class="col-xl-4 col-lg-3">
                <div class="single-departments-box marginbottom text-center wow fadeInRight" data-wow-duration="1s"
                    ...
                    <div class="">
                        ...
                        <div class="text">
                            <p class="text-justify">Dengan kapasitas produksi yang besar, yaitu mencapai 2.000 pcs per
                ...
                <div class="single-departments-box text-center wow fadeInRight" data-wow-duration="1s"
                    ...
                    <div class="">
                        ...
                        <div class="text">
                            <p class="text-justify">Kami hanya menggunakan bahan berkualitas tinggi dan team produksi
        ...
        <div class="row">
            ...
            <div class="col-xl-2 col-lg-4 col-md-4">
                <div class="single-partner-logo-box-style2">
                    <a href="#"><img src="{{ asset('assets/images/sponsor/1.png') }}" alt="Awesome Image"></a>
                </div>
            </div>
            ...
            <div class="col-xl-2 col-lg-4 col-md-4">
                <div class="single-partner-logo-box-style2">
                    <a href="#"><img src="{{ asset('assets/images/sponsor/2.png') }}" alt="Awesome Image"></a>
                </div>
            </div>
            <!--End Single Partner Logo Box-->
            <!--Start Single Partner Logo Box-->
            <div class="col-xl-2 col-lg-4 col-md-4">
                <div class="single-partner-logo-box-style2">
                    <a href="#"><img src="{{ asset('assets/images/sponsor/3.png') }}" alt="Awesome Image"></a>
                </div>
            </div>
            <!--End Single Partner Logo Box-->
            <!--Start Single Partner Logo Box-->
            <div class="col-xl-2 col-lg-4 col-md-4">
                <div class="single-partner-logo-box-style2">
                    <a href="#"><img src="{{ asset('assets/images/sponsor/4.png') }}" alt="Awesome Image"></a>
                </div>
            </div>
            <!--End Single Partner Logo Box-->
            <!--Start Single Partner Logo Box-->
            <div class="col-xl-2 col-lg-4 col-md-4">
                <div class="single-partner-logo-box-style2">
                    <a href="#"><img src="{{ asset('assets/images/sponsor/5.png') }}" alt="Awesome Image"></a>
                </div>
            </div>
            <!--End Single Partner Logo Box-->
            <!--Start Single Partner Logo Box-->
            <div class="col-xl-2 col-lg-4 col-md-4">
                <div class="single-partner-logo-box-style2">
                    <a href="#"><img src="{{ asset('assets/images/sponsor/6.png') }}" alt="Awesome Image"></a>
                </div>
            </div>
            <!--End Single Partner Logo Box-->
        </div>
